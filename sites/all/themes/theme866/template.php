...
/**
 * @file
 * Contains theme override functions and process & preprocess functions for theme866
 */

// Auto-rebuild the theme registry during theme development.
if (theme_get_setting('theme866_clear_registry')) {
	// Rebuild .info data.
 ...
 */
function theme866_html_head_alter(&$head_elements) {
 ...
 */
function theme866_preprocess_search_block_form(&$vars) {
 ...
 */
function theme866_preprocess(&$vars, $hook) {
	$vars['theme866_path'] = base_path() . path_to_theme();
}
 ...
 */
function theme866_preprocess_page(&$vars) {
 ...
 */
function theme866_preprocess_block(&$vars, $hook) {
 ...
 */
function theme866_menu_tree($vars) {
 ...
 */
function theme866_field__taxonomy_term_reference($vars) {
	$output = '';
 ...
 */
function theme866_breadcrumb($vars) {
	
	$breadcrumb = isset($vars['breadcrumb']) ? $vars['breadcrumb'] : array();

// Determine if we are to display the breadcrumb.
	$show_breadcrumb = theme_get_setting('theme866_breadcrumb_display');
	if ($show_breadcrumb == 'yes') {
	
		if (theme_get_setting('theme866_breadcrumb_hideonlyfront')) {
			$condition = count($breadcrumb) > 1;
		} else {
			$condition = !empty($breadcrumb);
		}

		if(theme_get_setting('theme866_breadcrumb_showtitle')) {
		...
		$separator = theme_get_setting('theme866_breadcrumb_separator');
 ...
 * @return bool
 */
function theme866_tabs_float() {
	$float = (bool) theme_get_setting('theme866_tabs_float');
	$float_node = (bool) theme_get_setting('theme866_tabs_node');
...
function theme866_id_safe($string) {
	// Strip accents
 ...
 * @ingroup themeable
 */
function theme866_menu_link(array $vars) {
	...
	$element['#attributes']['class'][] = theme866_id_safe($element['#title']);
 ...
 */
function theme866_preprocess_menu_local_task(&$vars) {
 ...
 */
function theme866_menu_local_tasks(&$vars) {
	$output = '';
