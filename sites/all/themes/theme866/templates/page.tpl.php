            ...
            <div class="section-1 clearfix">
                <div class="container-12">
                    <div class="grid-12">
                        ...
                        <div class="col2">
                            <?php if ($page['info_block']): ?>
                                <div class="section-5 clearfix">
                                    <?php print render($page['info_block']); ?>
                                </div>
                            <?php endif; ?>
                            <?php if ($page['menu']): ?>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-53c6d809388b673a"></script>
